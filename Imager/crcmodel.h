...
typedef struct {
	...
	unsigned int  cm_refin;   /* Parameter: Reflect input bytes?        */
	unsigned int  cm_refot;   /* Parameter: Reflect output CRC?         */
...
void cm_blk (cm_t* p_cm, unsigned char* blk_adr, ulong blk_len);
